...
var _a, _Devvit_appSettings, _Devvit_assets, _Devvit_config, _Devvit_customPostType, _Devvit_formDefinitions, _Devvit_installationSettings, _Devvit_menuItems, _Devvit_scheduledJobHandlers, _Devvit_triggerOnEventHandlers, _Devvit_webViewAssets, _Devvit_domains, _Devvit_additionallyProvides, _Devvit_uses, _Devvit_pluginClients;
...
export class Devvit extends Actor {
    ...
    constructor(config) {
        ...
        if (__classPrivateFieldGet(_a, _a, "f", _Devvit_domains).length > 0) {
            config.addPermissions({ requestedFetchDomains: __classPrivateFieldGet(_a, _a, "f", _Devvit_domains) });
        }
    }
}
_a = Devvit;
